...
def main():
    ...
    if choice == 'Mapa de denuncias':
        ...
        st.write("El visualizador de denuncias es una herramienta informática que permite a los ciudadanos reportar y monitorear problemas como son : baquetas,alumbrado publico,entre otros.Esta herramienta permite a los usuarios informar de problemas específicos en una ubicación específica, así como darle seguimiento a las soluciones que se dan.El objetivo principal es mejorar la eficiencia y la transparencia en la gestión de problemas públicos y ayudar a las autoridades locales a tomar decisiones informadas para abordar los problemas en la comunidad.")
        st.header("Tipos de problemas que se reportan")
        st.write("Paso peatonal : Falta de pasos peatonales o en mal estado")
        st.write("Ejemplo : El puente peatonal le faltan escaleras o barandal")
        st.image("imagesM/pasopeatonal.png",width=50)
        st.write("Rampas : Nos muestra la falta de rampas para personas con discapacidad asi como las que necesitan mantenimiento .")
        st.write("Ejemplo : No  hay rampa en la escuela Benito Júarez para un niño con silla de ruedas.")
        st.image("imagesM/rampas.png",width=50)
        st.write("Vandalismo : Representa daños al espacio publico.")
        st.write("Ejemplo : Grafitis,destrucción de areas verdes etc.")
        st.image("imagesM/valdalismo.png",width=50)
        st.write("Seguridad : Muestra el nivel o grado  de inseguridad.")
        st.write("Ejemplo : Robos a peatones a mano armada.")
        st.image("imagesM/seguridad.png",width=50)
        st.write("Luminarias : Representa la careancia o falta de mantenimiento de ellas.")
        st.write("Ejemplo : No hay alumbrado publico en calle mungia,cerca de la primaria")
